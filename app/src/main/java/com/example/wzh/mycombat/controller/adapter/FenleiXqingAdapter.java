...
public class FenleiXqingAdapter extends RecyclerView.Adapter<FenleiXqingAdapter.MyViewHolder> implements View.OnClickListener {

    private Context mContext;
    private List<FLXBean.DataBean.ItemsBean> datas;
    private OnItemClickListener mOnItemClickListener;

    public FenleiXqingAdapter(Context mContext, List<FLXBean.DataBean.ItemsBean> datas) {
