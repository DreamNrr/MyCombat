...
public class LiveAppIndexAdapter extends RecyclerView.Adapter {
    ...
    static class LiveBannerViewHolder extends RecyclerView.ViewHolder {
        ...
        @InjectView(R.id.item_live_banner)
    ...
    static class LiveEntranceViewHolder extends RecyclerView.ViewHolder {
        ...
        @InjectView(R.id.live_entrance_title)
        public TextView title;

        @InjectView(R.id.live_entrance_image)
    ...
    static class LivePartitionViewHolder extends RecyclerView.ViewHolder {
        ...
        @InjectView(R.id.item_live_partition_icon)
        ImageView itemIcon;

        @InjectView(R.id.item_live_partition_title)
        TextView itemTitle;

        @InjectView(R.id.item_live_partition_count)
        TextView itemCount;
