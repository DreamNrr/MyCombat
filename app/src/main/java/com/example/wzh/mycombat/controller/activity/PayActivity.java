...
import com.example.wzh.mycombat.utils.PayKeys;
import com.example.wzh.mycombat.utils.PayResult;
import com.example.wzh.mycombat.utils.SignUtils;
...
public class PayActivity extends BaseActivity {
    ...
    private void showPay() {
        // 订单
        //商品名---商品详情----价格
        String orderInfo = getOrderInfo("测试的商品", "该测试商品的详细描述", jiage);
